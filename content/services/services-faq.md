...
Дизайнерка має 5-річну архітектурну освіту та 8 років досвіду в сфері дизайну інтер’єру загалом та 6 років досвіду індивідуального проектування. Також має успішний досвід реалізації [різноманітних проектів](/landusheva/portfolio), включаючи житлові та комерційні інтер'єри, та працювала з різними стилями та бюджетами.
...
{{< callout emoji="❓" >}}
  Є питання, на яке тут не була дана відповідь? [Напишіть нам](/landusheva/contact). 
{{< /callout >}}
